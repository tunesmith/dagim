...
Generally, almost any process with multiple dependencies 
is better represented as a DAG. But easy tools and utilities 
for graphs lag other text-based tools. *dagim* seeks to shrink 
that gap somewhat.

*Instructions:* Use dagim to edit a file. Press `a` to add
